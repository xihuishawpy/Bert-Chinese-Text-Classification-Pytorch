...
class BertTokenizer(object):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, cache_dir=None, *inputs, **kwargs):
        ...
        try:
            ...
            logger.error(
                f"Model name '{pretrained_model_name_or_path}' was not found in model name list ({', '.join(PRETRAINED_VOCAB_ARCHIVE_MAP.keys())}). We assumed '{vocab_file}' was a path or url but couldn't find any file associated to this path or url."
            )
